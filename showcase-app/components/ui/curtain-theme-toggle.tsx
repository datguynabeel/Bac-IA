...
const TOKENS: Record<Theme, Record<string, string>> = {
  light: {
    pageBg:    "#F5EDE0",  // Blanc cassé SIRAJ
    pageText:  "#0F1419",  // Sombre profond SIRAJ
    barBg:     "#0F1419",
    barText:   "#F5EDE0",
    barBorder: "rgba(232,184,96,0.15)",  // Doré transparent
    btnBg:     "#E8B860",  // Doré principal SIRAJ
    btnText:   "#0F1419",
    btnRing:   "rgba(232,184,96,0.4)",
    inputBg:   "rgba(245,237,224,0.1)",
    inputText: "#F5EDE0",
  },
  dark: {
    pageBg:    "#0F1419",
    ...
    barBg:     "#F5EDE0",
    barText:   "#0F1419",
    barBorder: "rgba(232,184,96,0.20)",
    btnBg:     "#E8B860",
    btnText:   "#0F1419",
    btnRing:   "rgba(232,184,96,0.5)",
    inputBg:   "rgba(15,20,25,0.08)",
    inputText: "#0F1419",
  },
};
