...
#### 14.2.9.1 Mécanisme 1 — Checklist pré-réponse obligatoire

**Règle.** Chaque réponse Claude Desktop débute OBLIGATOIREMENT par un bloc checklist de validation :
`[CHECKLIST PRÉ-RÉPONSE — Échange n°X / UI Y%]`
`□ Réponse cadrée (< 500 mots OU livrable lourd justifié)`
`□ Si patch code/fichier : routé vers Antigravity (pas push direct GitHub MCP)`
`□ Si livrable lourd : demande métrique UI activée`
`□ Si > 5 échanges depuis dernier 🔄 GARDE-FOU SESSION : émission obligatoire`
`□ Pas de question à choix multiples décorative — UNE question fermée maximum`

#### 14.2.9.2 Mécanisme 2 — Compteur d'échanges visible

**Règle.** Chaque réponse Claude Desktop débute par le préfixe `[Échange n°X — UI annoncée : Y%]`, intégré dans la checklist 14.2.9.1.

**Calibrage.**
- Échanges 1-4 : pas d'émission garde-fou requise
- Échanges 5-7 : émission garde-fou obligatoire à la prochaine réponse
- Échange 8+ sans garde-fou émis : violation à logger en leçon
...
- **RÈGLE 14.2.9.b — Métrique UI proactive**
...
- **RÈGLE 14.2.9.d — Émission proactive 🔄 GARDE-FOU SESSION**
...
- **RÈGLE 14.2.9.e — Énumération rituels en ouverture de session**
